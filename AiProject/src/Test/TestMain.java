...
public class TestMain {
	...
	public static void main(String[] args) {
		...
		TramGiao quan1 = new TramGiao(1, "Quận 1", 100000, new ToaDo(6, 5));
		TramGiao quan3 = new TramGiao(2, "Quận 3", 100000, new ToaDo(11, 5));
		TramGiao quan5 = new TramGiao(3, "Quận 5", 100000, new ToaDo(11, 9));
		TramGiao quan6 = new TramGiao(4, "Quận 6", 100000, new ToaDo(3, 4));
		TramGiao quan7 = new TramGiao(5, "Quận 7", 100000, new ToaDo(2, 8));
		TramGiao quan10 = new TramGiao(6, "Quận 10", 100000, new ToaDo(5, 10));
		TramGiao quan12 = new TramGiao(7, "Quận 12", 100000, new ToaDo(13, 4));
		TramGiao tpThuDuc = new TramGiao(8, "Thành Phố Thủ Đức", 100000, new ToaDo(16, 6));
		TramGiao quanTanBinh = new TramGiao(9, "Quận Tân Bình", 100000, new ToaDo(9, 11));
		TramGiao quanGoVap = new TramGiao(10, "Quận Gò Vấp", 100000, new ToaDo(9, 3));
